...
#BASE_URL przechowuje pierwotny adres do strony xkcd.com
BASE_URL = "http://xkcd.com"

class MainWindow:
    """
    Klasa implementujaca wyglad oraz funkcjonalnosc programu,
    ktory ma na celu wyswietlanie i pobieranie komiksow ze strony xkcd.com.
    """

    def __init__(self):
        """
        Funkcja inicjalizujaca widgety programu.
        """

        #przechowywanie aktualnego adresu
        self.surl = "http://xkcd.com"
        #przechowywanie maksymalnego numeru komiksu
        self.maxNumber = ""
        ...
        self.imgFile = ""
        self.image.set_from_file(self.imgFile)
        self.image.show()
    ...
    def searchImage(self, button):
        """
        funkcja wyszukujaca komiks o podanym w searchEntry numerze.
        """
    ...
    def preImage(self, button):
        """
        Funkcja wyswietlajaca poprzedni komiks.
        """
    ...
    def randImage(self, button):
        """
        Funkcja wyswietlajaca losowy komiks.
        """
    ...
    def nextImage(self, button):
        """
        Funkcja wyswietlajaca nastepny komiks.
        """
    ...
    def getSoup(self, url = BASE_URL):
        """
        Funkcja zwracajaca dane strony, ktorej adres podano
    ...
    def showImage(self, number):
        """
        Funkcja wyswietlajaca zdjecie na podstawie podanego numeru
        :param number: numer komiksu.
        """
        ...
        #szukanie czy juz nie pobrano komiksu
        ...
        if imageExist:
            self.image.set_from_file(os.path.join('cache', filename))
        else:
    ...
    def getImage(self, number):
        """
        Znajduje dane zdjecia.
        :param number: numer zdjecia.
        :return: adres zdjecia, tytul zdjecia, numer zdjecia
        """
